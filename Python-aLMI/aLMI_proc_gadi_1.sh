#!/bin/bash
#PBS -P r78
#PBS -l walltime=10:00,mem=4GB,ncpus=1
#PBS -l wd
...
CONFIG_FILE=./ini_files/aLMI_config_VDItest.ini

#-- Input file for this job: either define literally or get from the config file
# INPUT_DIR=/g/data/r78/aLMI/data/
# INPUT_FILE=${INPUT_DIR}A20120403_0410.20130805213444.L2.ANN_P134_V20140704.hdf
